...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/a1.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h6 class="heading">C# PROGRAMMING LANGUAGE</h6>
    <ul>
      <li><a href="../index.php">Home</a></li>
      <li><a href="chash.php">C#</a></li>
    </ul>
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          ...
          <figcaption>
            <h4><strong>C# language</strong></h4>
            <embed style="width: 720px;height: 450px;" src="https://www.youtube.com/embed/vLnPwxZdW4Y"></embed>
            <br>
            <p>C# is pronounced "C-Sharp".

                <br> It is an object-oriented programming language created by Microsoft that runs on the .NET Framework.
                
                <br> C# has roots from the C family, and the language is close to other popular languages like C++ and Java.
                
                <br> The first version was released in year 2002. The latest version, C# 8, was released in September 2019.
                ...
                <br>Games
                <br> VR
                <br> Database applications
                <br>And much, much more!.</p>
            <br>
            <h3><strong>Why Use C#</strong></h3>
            <p>
                <br>It is one of the most popular programming language in the world
                <br>It is easy to learn and simple to use
                <br> It has a huge community support
                <br> C# is an object oriented language which gives a clear structure to programs and allows code to be reused, lowering development costs.
                <br>As C# is close to C, C++ and Java, it makes it easy for programmers to switch to C# or vice versa
            </p>
