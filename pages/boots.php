...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/a1.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h6 class="heading">Bootstrap  PROGRAMMING LANGUAGE</h6>
    <ul>
      <li><a href="../index.php">Home</a></li>
      <li><a href="boots.php">BS</a></li>
    </ul>
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          ...
          <figcaption>
            <h4><strong>Bootstrap language</strong></h4>
            <embed style="width: 720px;height: 450px;" src="https://www.youtube.com/embed/vpAJ0s5S2t0"></embed>
            <br>
            <p>Bootstrap is a free front-end framework for faster and easier web development
                <br>  Bootstrap includes HTML and CSS based design templates for typography, forms, 
                <br> buttons, tables, navigation, modals, image carousels and many other, as well 
                <br> as optional JavaScript plugins
                <br>Bootstrap also gives you the ability to easily create responsive designs.</p>
            <br>
            <h3><strong>Why Use Bootstrap?</strong></h3>
            <p>
                <br> Easy to use: Anybody with just basic knowledge of HTML and CSS can start using Bootstrap
                <br>Responsive features: Bootstrap's responsive CSS adjusts to phones, tablets, and desktops
                <br>Mobile-first approach: In Bootstrap, mobile-first styles are part of the core framework
                <br>Browser compatibility: Bootstrap 4 is compatible with all modern browsers (Chrome, Firefox, Internet Explorer 10+, Edge, Safari, and Opera)
            </p>
