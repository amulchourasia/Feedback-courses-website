  ...
  <section id="navwrapper" class="hoc clear"> 
    ...
    <nav id="mainav">
      <ul class="clear">
        ...
        <li><a href="student_response.php">My Response</a></li>
         <li><a href="course_opt.php">Opt for Course</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <?php 
            ...
            $sql="SELECT * FROM course_info JOIN feedback_status ON course_info.course_id=feedback_status.course_id JOIN course_teacher ON course_teacher.course_id=feedback_status.course_id JOIN faculty_info ON faculty_info.fac_id=course_teacher.fac_id;";
        ...
        echo'<br>Faculty Name &nbsp&nbsp:&nbsp';
        echo $row['fac_name'];
        echo'</h3><p style="color: #000; font-size: 0.9em; margin-top: 10px;">';
        echo'Course Feedback &nbsp&nbsp:&nbsp Not Given<br>';
        echo'<a href="submit_feedback.php?id='.urlencode($row['course_id']).'">Submit Feedback</a>';
        echo'</p></div>';
        $i=$i+1;
        }
        else if ($i%3==1) {
        ...
        echo $row['fac_name'];
        echo'</h3><p style="color: #000; font-size: 0.9em; margin-top: 10px;">';
        echo'Course Feedback &nbsp&nbsp:&nbsp Not Given';
        echo'<br><a href="submit_feedback.php?id='.urlencode($row['course_id']).'">Submit Feedback</a>';
        echo'</p></div>';
        $i=$i+1;
        }
        else
