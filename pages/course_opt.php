...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form action="course_opt_db.php" method="POST" enctype="multipart/form-data">
    <h6>OPT FOR A COURSE</h6>
    <select name="course"><?php 
                ...
                <button type="submit" name="submit" id="submit" value="submit" style="width: 80px; height: 4vh; font-family: arial black; border-radius: 5px; border:none; margin-top: 20px;">UPDATE</button>
              </form>
    <!-- / main body -->
    <div class="clear"></div>
  </main>
