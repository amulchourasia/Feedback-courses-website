...
if (isset($_POST['submit'])) {
  ...
  $sql = "SELECT * FROM faculty WHERE userid='$email' AND password='$password'";
...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/pexels-adrien-olichon-2387793.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h6 class="heading">Faculty Login</h6>
    <ul>
      <li><a href="../index.php">Home</a></li>
      <li><a href="gallery.php">About us</a></li>
      <li><a href="contact.php">contact</a></li>
      <li><a href="logsin.php">Faculty Login</a></li>
    </ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <style>
          ...
          input[type=name],input[type=password],input[type=text]{
            width: 30%;
            margin: 5px 0 10px 0;
    ...
    <div class="content"> 
      ...
      <p class="login-text" style="font-size: 2rem; font-weight: 800;">Faculty Login</p>
      
      <input type="name" placeholder="Email" name="email" value="" required>
