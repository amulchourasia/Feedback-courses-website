...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/pexels-adrien-olichon-2387793.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <?php echo $_SESSION['faculty_name'];?></h6>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <?php 
            ...
            $sql="SELECT * FROM feedback JOIN course_info ON course_info.course_id=feedback.course_id JOIN student_info ON student_info.id=feedback.student_id JOIN questions ON questions.quest_id=feedback.quest_id JOIN feedback_status ON feedback.course_id=feedback_status.course_id JOIN course_teacher ON course_teacher.course_id=feedback.course_id AND course_teacher.fac_id='$fac_id'";
