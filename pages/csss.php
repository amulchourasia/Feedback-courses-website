...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/a1.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h6 class="heading">Css PROGRAMMING LANGUAGE</h6>
    <ul>
      <li><a href="../index.php">Home</a></li>
      <li><a href="csss.php">Css</a></li>
    </ul>
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          ...
          <figcaption>
            <h4><strong>Css language</strong></h4>
            <embed style="width: 720px;height: 450px;" src="https://www.youtube.com/embed/Edsxf_NBFrw"></embed>
            <br>
            <p>CSS stands for Cascading Style Sheets
                <br>  CSS describes how HTML elements are to be displayed on screen, paper, or in other media
                <br>   CSS saves a lot of work. It can control the layout of multiple web pages all at once
                <br> External stylesheets are stored in CSS files</p>
            <br>
            <h3><strong>Why Use Css?</strong></h3>
            <p>
