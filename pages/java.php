...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/a1.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h6 class="heading">Java PROGRAMMING LANGUAGE</h6>
    <ul>
      <li><a href="../index.php">Home</a></li>
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          ...
          <figcaption>
            <h4><strong>Java language</strong></h4>
            <embed style="width: 720px;height: 450px;" src="https://www.youtube.com/embed/hBh_CC5y8-s"></embed>
            <br>
            ...
            <h3><strong>Why Use Java</strong></h3>
            <p>
                ...
                <br>It is open-source and free
                <br>It is secure, fast and powerful
                <br>It has a huge community support (tens of millions of developers)
                <br>Java is an object oriented language which gives a clear structure to programs and allows code to be reused, lowering development costs
