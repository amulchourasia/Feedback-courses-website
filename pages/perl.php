...
<div class="bgded overlay" style="background-image:url('../images/demo/backgrounds/a1.jpg');"> 
  ...
  <div id="breadcrumb" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h6 class="heading">perl PROGRAMMING LANGUAGE</h6>
    <ul>
      <li><a href="../index.php">Home</a></li>
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          ...
          <figcaption>
            <h4><strong>Perl language</strong></h4>
            <embed style="width: 720px;height: 450px;" src="https://www.youtube.com/embed/IoLVCEr207w"></embed>
            <br>
            ...
            <br>
            <h3><strong>Why Use perl </strong></h3>
            <p>
                Perl takes the best features from other languages, such as C, awk, sed, sh, and BASIC, among others.

                <br>Perls database integration interface DBI supports third-party databases including Oracle, Sybase, Postgres, MySQL and others.

                <br>Perl works with HTML, XML, and other mark-up languages.

                <br>Perl supports Unicode.

                <br>Perl is Y2K compliant.

                <br>Perl supports both procedural and object-oriented programming.

                <br>Perl interfaces with external C/C++ libraries through XS or SWIG.

                <br>Perl is extensible. There are over 20,000 third party modules available from the Comprehensive Perl Archive Network (CPAN).

                <br>The Perl interpreter can be embedded into other systems
            </p>
